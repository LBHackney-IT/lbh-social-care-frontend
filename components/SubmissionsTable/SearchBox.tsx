...
const SearchBox = ({
  ...
  <div className="govuk-form-group lbh-form-group govuk-!-margin-top-3">
    <label
      className={label ? 'govuk-label lbh-label' : 'govuk-visually-hidden'}
      htmlFor="search"
    >
      {label}
    </label>
    <div className="lbh-search-box">
      <input
