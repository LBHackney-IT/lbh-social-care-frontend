...
import EditAllocationPriority from 'components/Allocations/EditAllocationPriority/EditAllocationPriority';
...
const DeAllocationPage = (): React.ReactElement => {
  ...
  return (
    <>
      <Seo title={`Edit allocation priority level`} />
