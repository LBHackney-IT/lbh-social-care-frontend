...
export const mashReferralFactory = Factory.define<MashReferral>(
  ({ sequence }) => ({
    ...
    contactDecisionUrgentContactRequired: false,
    contactCreatedAt: '2021-10-28T10:55:45.097Z',
    initialDecisionReferralCategory: 'test-referral-category',
    initialDecision: 'test-initial-decision',
    initialDecisionUrgentContactRequired: false,
    initialDecisionCreatedAt: '2021-11-01T15:12:05.097Z',
